  ...
  return (
    ...
    >
      <div className="buttons mb-3 d-flex gap-2">
        <ButtonComponent className="m-1 btn btn-primary px-5" onClick={OnSave}>Save</ButtonComponent>
        <ButtonComponent className="m-1 btn btn-danger px-5" onClick={OnClear}>Clear</ButtonComponent>
      </div>
      <SignatureComponent
